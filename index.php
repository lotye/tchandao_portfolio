...
<section class="home" id="home">
   ...
   <div class="content">
      <h3 data-aos="fade-up">Salut, je suis Abrahame</h3>
      <span data-aos="fade-up" >Conseiller clientèle </span>
      <p data-aos="fade-up">
       Le conseiller relation clientèle accueille, renseigne, 
       gère les réclamations et propose à la clientèle les services
       et avantages du magasin. Selon l'organisation et la taille
        du magasin, il prend en charge des services plus ou moins 
         étendus (détaxe, gestion des comptes des cartes de fidélité,
          billetterie, exportation, vestiaire, consigne,…).
      </p>
...
<section class="about" id="about">
   ...
   <div class="biography">
      ...
      <p data-aos="fade-up">Je me nomme Abrahame TCHANDAO, je suis une jeune togolais néé au Togo.Passionné par l'apprentissage et la polyvalence professionnelle,
         je suis un Commercial-marketeur autodictate . </p>

      <div class="bio">
         <h3 data-aos="zoom-in"> <span>Nom : </span> Abrahame TCHANDAO </h3>
         <h3 data-aos="zoom-in"> <span>E-mail : </span> abrahametchandao@gmail.com </h3>
         <h3 data-aos="zoom-in"> <span>Adresse : </span> Lome, TOGO </h3>
         <h3 data-aos="zoom-in"> <span>Tel : </span> +228 901201246120 </h3>
         <h3 data-aos="zoom-in"> <span>Age : </span> 20 ans </h3>
         <h3 data-aos="zoom-in"> <span>Experiences : </span> 3 ans</h3>
      </div>
   ...
   <div class="skills" data-aos="fade-up">
      ...
      <div class="progress">
         <div class="bar" data-aos="fade-left"> <h3><span>Prise en charge du standard</span> </h3> </div>
         <div class="bar" data-aos="fade-right"> <h3><span>Savoirs de l'action </span> </h3> </div>
         <div class="bar" data-aos="fade-left"> <h3><span>Savoirs théoriques et procéduraux</span> </h3> </div>
         <div class="bar" data-aos="fade-left"> <h3><span>Competences relationnelles</span> </h3> </div>
      </div>
      ...
      <div class="row">
         ...
         <div class="box-container">
            ...
            <div class="box" data-aos="fade-left">
               ...
               <p>Grace à l'auto-formation en graphisme nous concevons pour vous de jolis design pour vos communications visuelles. </p>
            </div>
...
<section class="contact" id="contact">
   ...
   <div class="box-container">
      ...
      <div class="box" data-aos="zoom-in">
         ...
         <h3>email</h3>
         <p>abrahametchandao@gmail.com</p>
      </div>
...
<div class="credit"> &copy; copyright @ <?php echo date('Y'); ?> by <span>Abrahame TCHANDAO</span> </div>
